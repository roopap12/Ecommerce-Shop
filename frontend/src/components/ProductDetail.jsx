...
const ProductDetail = () => {
  ...
  const handleCloseCart = () => {
   ...
   const handleRemoveItem = (itemId) => {
    ...
    // If the item is found, create a new array without the selected item
    if (itemIndex !== -1) {
      let updatedCartItems;
      if (itemIndex === 0) {
        // If the first item is being removed, use slice starting from index 1
        updatedCartItems = cartItems.slice(1);
      } else {
        // If any other item is being removed, use slice to exclude the selected item
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // const productId = productId; // useParams already extracts the id
        if (productId) {
          const uniqueProduct = await getProductById(productId);

          setProductById(uniqueProduct);
        }
      } catch (error) {
    ...
    console.log("ready to run fetch");
    fetchData();
  }, [productId]);
  ...
  return (
    <div className="2xl:container 2xl:mx-auto lg:py-25 lg:px-25 md:py-12 md:px-6 py-9 px-4 mt-[170px] ">
      ...
      <div className="flex justify-center items-center lg:flex-row flex-col gap-32">
        {/* <!-- Description Div --> */}

        <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
          <p className=" focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 font-normal text-base leading-4 text-gray-600">
            Home / Electronics / Laptop
          </p>
  ...
  <div className="w-full lg:w-1/6 grid lg:grid-cols-1 sm:grid-cols-2 grid-cols-1 gap-6">
    ...
    <div className="bg-gray-100 flex justify-center items-center py-4">
      ...
      <div className="flex justify-center items-center w-full lg:mt-32 mb-10">
  <div className="w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
    {/* Downward Arrow SVG */}
    <svg
      xmlns="http://www.w3.org/2000/svg"
      ...
      viewBox="0 0 24 24"
      stroke="currentColor"
      className="mx-auto mt-10 w-16 text-gray-300"
    >
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" />
    </svg>
  </div>
</div>
      <div className="flex justify-center items-center w-full lg:mt-20 mb-10">
        
        <div className="w-full sm:w-96 md:w-8/12 lg:w-full grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 lg:gap-28 sm:gap-x-6 sm:gap-y-12 gap-y-12 sm:mt-14 mt-10 mb-20">
          <div>
            <svg
              width="50"
              height="50"
            ...
            <p className="text-normal text-base leading-6 text-gray-600 mt-4">
              High water resistance means you can enjoy that favorite beverage
              without fear.{" "}
            </p>
          </div>
          <div>
            ...
            <p className="text-normal text-base leading-6 text-gray-600 mt-4">
              All our laptops come with a 5 year warranty for peace of mind. We
              back the durability of our products.{" "}
            </p>
          </div>
          <div>
            <svg
            ...
            <p className="text-normal text-base leading-6 text-gray-600 mt-4">
              {" "}
              All our products are made with recycled material, reduce your
              carbon footprint with KiwiMall.{" "}
            </p>
          </div>
          <div>
            <svg
            ...
            <p className="text-normal text-base leading-6 text-gray-600 mt-4">
              {" "}
              We offer one day shipping to all suburban addresses. 3 days max
              for rural.{" "}
            </p>
          </div>
        </div>
