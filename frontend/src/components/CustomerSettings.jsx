...
//     };
//     return (
//         <form id="login" onSubmit={handleSubmit} className="w-full">
...
//                                 </div>
//                             </div>
//                             <div className="mt-16 flex flex-col xl:w-2/6 w-full">
...
//                             </div>
//                             <div className="mt-8 flex flex-col xl:w-3/5 w-full">
...
//                             <div className="xl:w-1/4 flex flex-col mb-6">
