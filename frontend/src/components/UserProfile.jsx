        ...
        >
          ...
          <div className="xl:mt-6 flex flex-col justify-start items-start  px-4 w-full space-y-3 pb-5 ">
            ...
            <button className="flex justify-start items-center space-x-6 hover:text-white focus:outline-none focus:bg-indigo-700 focus:text-white hover:bg-indigo-700 text-gray-600 rounded py-3 pl-4  w-full ">
              ...
              <p className="text-base leading-4  ">Wishlist</p>
            </button>
          </div>
          ...
          <div className="mt-6 flex flex-col justify-start items-start  px-4 w-full space-y-3 pb-5 ">
            ...
            <Link>
              <button
                className="focus:outline-none flex justify-start items-center space-x-6 hover:bg-indigo-700 hover:text-white text-gray-600 rounded py-3 pl-4 w-full transition duration-300 ease-in-out"
